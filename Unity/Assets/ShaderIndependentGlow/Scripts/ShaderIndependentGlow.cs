...
public class ShaderIndependentGlow : MonoBehaviour {
	...
	void OnRenderImage(RenderTexture src, RenderTexture dest) 
	{
        ...
        glowRT = RenderTexture.GetTemporary(src.width >> maskDownsample, src.height >> maskDownsample, 24, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
        ...
        blurRT = RenderTexture.GetTemporary(src.width, src.height, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
        ...
        RenderTexture tempRT = RenderTexture.GetTemporary(src.width,src.height, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
